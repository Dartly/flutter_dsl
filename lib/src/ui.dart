...
class UI {
  ...
  /// 创建ListView构建器
  static ListViewBuilder listView([List<Widget>? children]) => children != null
      ? ListViewBuilder().children(children)
      : ListViewBuilder();
  ...
  static BottomNavigationBarBuilder bottomNavigationBar() =>
  ...
  /// 创建ElevatedButton构建器
  static ElevatedButtonBuilder elevatedButton(String text) =>
      ElevatedButtonBuilder(text);

  /// 创建OutlinedButton构建器
  static OutlinedButtonBuilder outlinedButton(String text) =>
      OutlinedButtonBuilder(text);
  ...
  /// 创建自定义Widget构建器
  static CustomWidgetBuilder custom(Widget widget) =>
      CustomWidgetBuilder(widget);

  ///创建CupertinoPageScaffold构建器
  static CupertinoPageScaffoldBuilder cupertinoPageScaffold() =>
      CupertinoPageScaffoldBuilder();

  ///创建CupertinoNavigationBar构建器
  static CupertinoNavigationBarBuilder cupertinoNavigationBar() =>
      CupertinoNavigationBarBuilder();

  ///创建CupertinoTextField构建器
  static CupertinoTextFieldBuilder cupertinoTextField() =>
      CupertinoTextFieldBuilder();
}
